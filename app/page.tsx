      ...
      <nav style={{ background: "#0a0a0fcc", borderColor: "#1e1e2e", backdropFilter: "blur(12px)" }} className="sticky top-0 z-50 border-b">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3 min-w-0">
            <div style={{ background: "#10b981", borderRadius: "6px" }} className="w-7 h-7 flex items-center justify-center shrink-0">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M2 2h4v4H2zM8 2h4v4H8zM2 8h4v4H2zM8 8h4v4H8z" fill="white" />
              </svg>
            </div>
            <span className="font-semibold text-sm tracking-tight truncate min-w-0" style={{ color: "#f1f5f9" }}>
              Data Engineering Foundation
            </span>
            <div className="flex items-center shrink-0" style={{ gap: "12px", marginLeft: "4px" }}>
              {[
